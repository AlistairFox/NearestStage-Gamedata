...
#define G_PUDDLES_BORDER_HARDNESS			0.6f	// Border hardness. ( 1.0f = Extremely defined border )
#define G_PUDDLES_TERRAIN_EXTRA_WETNESS		0.0f	// Terrain extra wetness when raining. ( Over time like puddles )
...
#define G_PUDDLES_REFRACTION_INTENSITY		0.8f	// Refraction intensity
