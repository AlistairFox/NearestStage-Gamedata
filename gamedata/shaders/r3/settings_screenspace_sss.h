...
#define G_SSS_STEPS						6		// More steps = better quality / poor performance. ( 24 = Low | 32 = Medium | 48 = High | 64 = Ultra )
#else
#define G_SSS_STEPS						0		// More steps = better quality / poor performance. ( 24 = Low | 32 = Medium | 48 = High | 64 = Ultra )
#endif
...
#define G_SSDO_SCENARY_HARDNESS			0.0f	// Scenary shadow hardness. 0.0f to disable scenary shadows.
#define G_SSDO_SCENARY_SHADOW_LENGTH	0.0f	// Scenary maximum shadow length.

#define G_SSDO_GRASS_HARDNESS			0.0f	// Grass shadow hardness.
#define G_SSDO_GRASS_SHADOW_LENGTH		0.0f	// Grass maximum shadow length.
